...
const channels = [
  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-7 h-7">
        <path d="M12 21a9 9 0 1 0-7.5-4l-1.5 4 4-1.5A8.96 8.96 0 0 0 12 21Z" strokeLinecap="round" strokeLinejoin="round" />
...
export default function Channels() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-white via-cream-warm/30 to-cream" />
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mt-4 text-ink-light text-lg max-w-lg mx-auto">
            Your crew lives in the channels you use. No new apps to install, no
            new habits to learn.
          </p>
        </motion.div>
