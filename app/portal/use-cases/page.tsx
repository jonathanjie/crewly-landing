...
const USE_CASES: UseCaseCategory[] = [
  {
    ...
    templates: [
      { name: "Knowledge Brain", slug: "knowledge-brain", icon: "\uD83D\uDCDA" },
    ],
    status: "available",
  },
  {
    ...
    templates: [
      { name: "Support L1 Deflector", slug: "support-l1", icon: "\uD83D\uDCAC" },
      { name: "SDR Prospector", slug: "sdr-prospector", icon: "\uD83D\uDCCA" },
    ],
    status: "available",
  },
  {
    ...
    templates: [
      { name: "Project Manager", slug: "project-manager", icon: "\u2699\uFE0F" },
      { name: "Maritime Ops", slug: "maritime-ops", icon: "\u26F4\uFE0F" },
      { name: "HR Onboarding", slug: "hr-onboarding", icon: "\uD83D\uDC65" },
    ],
    status: "available",
  },
  {
